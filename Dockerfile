# ITCS355 Lab 1 — training image. This multi-architecture manifest digest was
# resolved on 2026-09-07; `make image` selects linux/amd64.
...
# Refuse artifacts not recorded in the compiled lock file.
